...
CURRENT_VERSION = "PlexInviter V1.0"
...
def update_table(conn, tablename):
    ...
    # Update to PlexInviter V1.0 table
    if version == "Invitarr V1.0":
        print("Upgrading DB table from Invitarr v1.0 to PlexInviter V1.0")
        # Create temp table
        conn.execute(
